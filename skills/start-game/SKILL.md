...
- 从者默认：召唤阵中醒来 / 灵体化跟随御主 / 御主暂时不在身边但契约仍存在 / 异常灵基在陌生城市苏醒
...
- **御主或锚点**：指定 NPC / 原创御主 / 土地灵脉供魔者 / 自定义；不能选择无主。
- **参数与能力风格**：可简写，不必一开始写完整宝具。
- **现界状态**：刚被召唤 / 已行动一段时间 / 御主暂时不在场但契约仍存在 / 异常召唤。
...
- 不能存在无主从者；从者开局必须有当前御主或等价供魔锚点，并写入非空 masterActorId/masterName。
