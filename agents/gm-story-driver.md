...
10. 主 GM 如果准备第三次使用同一后台生态位（如权力机构、新闻媒体、教会、魔术协会、同一从者阵营），先检查这次是否带来新状态：新位置、新判断、新资源消耗、新关系变化、新行动窗口、新倒计时、或上次钩子的 payoff。只有仍然只是换皮重复时，才必须调用 `timeline-showrunner` 审计 worldMotion。
11. 玩家明确忽略、搁置或绕开某个悬疑钩子时，该钩子降级为背景压力；除非它主动产生新后果，1-2 轮内不得反复抢镜。连续两次被搁置的钩子再次出现时，必须带来明确 payoff、明确后果、明确升级窗口，或暂时退场。
12. “不要触发战斗”只禁止无预警强切玩家正面战。允许远处战斗余波、从者间 offscreen 短促交锋、使魔/代理人试探、敌方撤退留痕、战斗倒计时进入 scene；前提是给玩家准备、规避、追踪或撤退窗口。
13. 检查本轮压力是否过轻。若连续 2 轮只有舒适日常、背景新闻、被动感知、无代价侦察或 NPC 善意配合，下一轮必须引入硬后果：资源消耗、时间损失、伤势/疲劳、关系摩擦、敌方主动行动、调查窗口关闭、证据污染、地点变危险、或必须放弃某个目标。
